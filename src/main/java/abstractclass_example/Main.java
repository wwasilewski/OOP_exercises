...
//        Animal animal1 = new Animal();           //cannot instantiate abstract class
...
//        animalActions.animalDialog(animal1, animal2);   //cannot instantiate abstract class
